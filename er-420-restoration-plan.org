...
- Handle old carbon comp resistors gently. The end-cap crimp can work
  loose from bumping or flexing the leads, causing a sudden open —
  that's a fault you caused, not one you found.
...
* DONE Phase 0 — Before the cover comes off [4/4]
CLOSED: [2026-08-06 Thu 09:20]

- CLOSING NOTE [2026-08-06 Thu 09:20]
...
** DONE 2. Build or borrow a dim bulb tester
CLOSED: [2026-08-04 Tue 22:56]
- CLOSING NOTE [2026-08-04 Tue 22:56] \\
  I bought and built the dim bulb tester, but the housing isn't quite right. I need to get a new housing
...
* TODO Phase 2 — Survey before touching anything [17/18]
...
** DONE 7. Trace C96
CLOSED: [2026-07-29 Wed 21:44]
- CLOSING NOTE [2026-07-29 Wed 21:44] \\
  Found C96 to be a green Oki film capacitor wired directly across the power
  switch and not an oil paper capacitor. The evidence of film capacitor vs the
  light duty cycle and benign failure mode, I'm not going to replace this
  capacitor
...
the safety cap disposition — see Phase 5.

** DONE 10. Verify R77/R79/R80 connection point
CLOSED: [2026-07-29 Wed 22:18]
- CLOSING NOTE [2026-07-29 Wed 22:18] \\
  We verified that R79 and R80 are actually 16 Ohm wire wrap resistors. With S8 switched off, T7/T8's secondary is not actually open. It still sees the real path through R79/R80 in parallel with R77/R78 (100 Ohm).
...
** DONE 11. Inventory tubes
CLOSED: [2026-08-12 Wed 01:31]
Confirm all present and correct types per the parts list. Note any
substitutions. Check for obvious shorts with the DMM.

** DONE 12. Test C49, C50, C51, C52 (0.1 µF Mylar)
CLOSED: [2026-07-29 Wed 22:46]
- CLOSING NOTE [2026-07-29 Wed 22:46] \\
  I found all four capacitors near V6-V9. I did a simple continuity test on them
  while in circuit none of them showed shorted it out. Did not lift a lead to be
  completely certain. I'm pretty certain it's resin-dipped.
*Priority.* These feed the output tube grids directly. You have no
replacements. If any leak, order before you get further.

** DONE 13. Test remaining Mylars
CLOSED: [2026-07-29 Wed 23:12]
- CLOSING NOTE [2026-07-29 Wed 23:12] \\
  Continuity test shows all either open loop, or resistance of 1MOhm +
C9, C10, C21, C22 (0.1 µF) — audio chain, in scope.

** DONE 14. In-circuit resistor sweep
CLOSED: [2026-07-30 Thu 00:02]
- CLOSING NOTE [2026-07-30 Thu 00:02] \\
  I did a sweep of the resistors on the power lines and signal path. Basically,
  every resistor that connected to a tube (but not the tubes for the MPX or IF
  tuner). Only three were out of spec and they were low. It's likely it was the
  in-circuit network that was pulling them down. I was using claude mobile in voice
  mode. So i called out the bands, got a value from claude, then measured. I taped
  the resistors that were out of spec, but I didn't write anything down.
...
** DONE 15. Survey all the gray electrolytics against bom.org
CLOSED: [2026-08-12 Wed 01:27]
- CLOSING NOTE [2026-08-12 Wed 01:27] \\
  All the electrolytic and oil caps identified. the 60uF cap is a replacement for C53 and C54.
At least one (ELNA, 60µF/150V, seen in bottom-close-up-05) doesn't
match any of the 17 electrolytic designators currently in bom.org.
Prompted by a forum comment ("the grey caps need to go") plus a rough
visual count of ~15 grey-bodied electrolytics scattered through the
chassis — go through the bottom-close-up and cap-close-up photos
systematically, note every visible one's printed value/voltage, and
cross-check against bom.org to find out how many are genuine gaps
versus already-catalogued parts not yet matched to a photo.

** DONE 16. Survey all the oil-paper caps against bom.org
CLOSED: [2026-08-12 Wed 01:30]
- CLOSING NOTE [2026-08-12 Wed 01:30] \\
  All electrolytic and oil paper caps surveyed
Same idea as the gray-electrolytic survey above: 14 oil-paper
designators are currently catalogued (C7, C8, C13, C14, C19, C20,
C25, C26, C47, C48, C56, C60, C70, C96 — all 0.02µF or 0.05µF at
400V). Go through the teardown photos and count/identify the
physical oil-paper caps the same systematic way, and confirm the
physical population matches what's in bom.org before assuming the
list is complete — this is the highest-priority failure mode in the
whole set, so a gap here matters more than most.

** DONE 17. Sweep VR2 (volume) resistance through full travel
CLOSED: [2026-08-05 Wed 19:22]
- CLOSING NOTE [2026-08-05 Wed 19:22]
Suspect in the acquisition-night symptom: loud at minimum, distorts
almost as soon as it's turned up (see [[file:history.org]]). Tonight's
continuity check only confirmed VR2's grounding topology is correct
(case and the shared cold-end terminal both ground, nothing
miswired) — it didn't test the actual variable-resistance behavior,
which is what would cause this symptom.

Measure wiper-to-end resistance on both sections (VR2 1/2, VR2 2/2)
while rotating through full travel. Look for smooth, monotonic change
versus jumps, dead spots, or resistance failing to approach zero
right at the minimum end — classic wear pattern from decades
concentrated in a "normal listening" range, leaving the rarely-used
extremes thin or worn through. If it's genuinely worn track rather
than dirty contacts, DeOxit (Phase 3) won't fix it — would need a
replacement pot instead.

** TODO 18. Place second parts order
...
*** SKIPPED Order C600 replacement: 68uF 200WV

* TODO Phase 3 — Clean before you solder [2/5]

** TODO 1. Blow out dust
Compressed air, outdoors. Sixty years of it.

** DONE 2. DeOxit all switches
CLOSED: [2026-08-05 Wed 19:22]
- CLOSING NOTE [2026-08-05 Wed 19:22] \\
  Actually performed on 7/28/2026
...
** TODO 5. Re-clean the S1 switch
Paying closer to the switch, there's still quite a bit of grime on the 4/4R
wiper and clips for the tie-in lugs. I made an early attempt at cleaning them
when I first got the unit. It probably needs to be re-done at some point. Rather
than just spray and pray it with Deoxit, it would probably be better to use a
q-tip to apply Deoxit to the wiper and lugs generously and then work them
through the positions.

* DONE Phase 4 — Output section decision [4/4]
CLOSED: [2026-09-21 Mon 09:51]
- CLOSING NOTE [2026-09-21 Mon 09:51]
** DONE 1. Fix or Replace S7 impedance switch
CLOSED: [2026-07-29 Wed 19:54]
- CLOSING NOTE [2026-07-29 Wed 19:54] \\
  After seeing the switch it looks very repairable
...
** DONE 2. Clean and glue contacts
CLOSED: [2026-07-29 Wed 20:00]
- CLOSING NOTE [2026-07-29 Wed 20:00] \\
  ZXH Bond B-7000 used solvent based rubber cement. I'm afraid this might be
  subject to DoOxit mineral spirits disolving it. Not sure this switch will need
  DeOxit. I've already cleaned it before I glued it in place. On the plastic
  slide, there's definite grooves that hold the contact clip in place. That
  plastic is doing all the work keeping the clip from sliding within the guide.
** DONE 3. Cure adhesive 24 - 28 hours
CLOSED: [2026-08-05 Wed 19:21]
- CLOSING NOTE [2026-08-05 Wed 19:21]
** DONE 4. Re-assemble switch and circuit board
CLOSED: [2026-08-05 Wed 19:21]
- CLOSING NOTE [2026-08-05 Wed 19:21] \\
  Re-assembled and re-installed. Works like a champ!
* TODO Phase 5 — Power supply [8/9]
...
** DONE 2. C101, C102 → 100 µF 350 V Nichicon
CLOSED: [2026-09-10 Thu 22:29]
- CLOSING NOTE [2026-09-10 Thu 22:29] \\
  Replaced C101 on [[file:log/2026-09-09-v1-v3-swap-and-c101-recap.org][2026-09-09]] and C102 on [[file:log/2026-09-10-c102-recap.org][2026-09-10]]
Observe polarity. Stripe = negative, long lead = positive.
Note: likely a voltage doubler, each cap sees ~190 V.

** DONE 3. C98 → 22 µF 450 V
CLOSED: [2026-09-12 Sat 15:30]

- CLOSING NOTE [2026-09-12 Sat 15:30] \\
  Installed [[file:log/2026-09-12-phase-5-other-caps.org][2026-09-12]]
** DONE 4. C99, C100
CLOSED: [2026-09-14 Mon 08:21]
- CLOSING NOTE [2026-09-14 Mon 08:21]
...
** SKIPPED 5. C94, C95 — remove
Come out and stay out under the 3-wire conversion. Pending only the
Phase 2 visual ID check, not a trace.

** DONE 6. C96 — install per Phase 2 trace result
CLOSED: [2026-09-12 Sat 15:43]
- CLOSING NOTE [2026-09-12 Sat 15:43] \\
  When inspecting the power switch component behind the shield, found C96 there. It's a ceramic disk and not a paper or electrolytic. Not replacing it. See [[file:component-notes.org][component-notes]] and [[file:photos/2026-07-29-power-switch-02.jpg][power switch photo]]
...
** DONE 7. C11, C12 → 22 µF 450 V
CLOSED: [2026-09-12 Sat 21:45]
- CLOSING NOTE [2026-09-12 Sat 21:45]
** DONE 8. C61 → 10 µF 450 V
CLOSED: [2026-09-12 Sat 21:45]
- CLOSING NOTE [2026-09-12 Sat 21:45]
** DONE 9. New 2 A slow-blow fuse
CLOSED: [2026-09-10 Thu 22:37]

- CLOSING NOTE [2026-09-10 Thu 22:37] \\
  I installed this a long time ago
* DONE Phase 6 — First power-up [6/6]

Nothing else gets replaced until the supply checks out.

** DONE 1. Visual inspection
CLOSED: [2026-09-14 Mon 08:21]
- CLOSING NOTE [2026-09-14 Mon 08:21]
Every new joint. Every polarity. Look for solder splash, stray strands,
leads touching what they shouldn't.

** DONE 2. Power up on the dim bulb tester
CLOSED: [2026-09-14 Mon 08:21]
- CLOSING NOTE [2026-09-14 Mon 08:21]
...
** DONE 3. Watch and smell for 30 seconds
CLOSED: [2026-09-14 Mon 08:21]
- CLOSING NOTE [2026-09-14 Mon 08:21]
Smoke, arcing, unusual noise, hot smell. Kill power at anything odd.

** DONE 4. Measure B+ rails against the schematic
CLOSED: [2026-09-14 Mon 08:22]
- CLOSING NOTE [2026-09-14 Mon 08:22]
...
** DONE 5. Measure output tube cathode voltage
CLOSED: [2026-09-14 Mon 08:22]
- CLOSING NOTE [2026-09-14 Mon 08:22]
...
** DONE 6. Only after all rails check out: run without the bulb limiter
CLOSED: [2026-09-14 Mon 08:22]

- CLOSING NOTE [2026-09-14 Mon 08:22]
* TODO Phase 7 — Audio chain [2/5]
...
** DONE 2. Coupling caps — the priority group
CLOSED: [2026-09-12 Sat 21:48]
- CLOSING NOTE [2026-09-12 Sat 21:48]
...
** DONE 3. Cathode bypass caps → 47 µF 50 V
CLOSED: [2026-09-12 Sat 21:50]
...
** SKIPPED 5. Mylars that failed Phase 2 testing
...
** DONE 4. Recap MPX electrolytics
CLOSED: [2026-09-12 Sat 21:46]
- CLOSING NOTE [2026-09-12 Sat 21:46]
C502 (3uF/150V) and C506 (20uF/250V), at minimum — both already
=received= in bom.org (3.3uF/160V and 22uF/450V respectively), just
never installed since the MPX board is out of scope for the
aux-only decision. That decision was about not chasing MPX
functionality, not a reason to leave 60-year-old electrolytics in
place indefinitely — worth a full pass over the MPX board's
electrolytics when this phase comes up, not just these two.

** TODO 5. Map out S1
The complexity of this selector switch is not to be understated. At some point
the thing to do is create a spreadsheet of all 8 wafer sides and 6 switch
positions using the DMM to map out continuity between all the lugs at each of
the positions. This would greatly help understanding the schematic, but doesn't
really help in the physical process of replacing the caps. Where it would come
in handy is when I'm trying to troubleshoot something that's going wrong and
need a deep understanding of the schematic.

* TODO Troubleshooting
** DONE Tap Test
With no audio, volume up, tap each tube with something non-metalic and listen to
the output. Any tubes that "ring" need to be replaced.
** TODO Tube pull test
gadget73, "could be noisy tubes, could be noisy resistors, could just be a noisy
circuit. Quick and dirty troubleshooting would just be to pull the first tube
signal gets to and see if it stops the noise. If not, move to the next, so on
and so forth. When you pull a tube and it goes away completely, the problem will
generally be at or immediately upstream of that stage."
...
Pulling a tube breaks the amplification at that point. Noise doesn't have to
travel through the amplification chain to reach the speaker. It can get injected
at a later stage through a completely separate path -- ripple on a shared B+
supply rail hitting a downstream tube's plate directly, RF pickup at a
downstream grid, or local oscillation happening entirely within a later statge.
...
it.
** TODO VR2 Signal Passes at Zero Volume
Both gangs stop at 15k - 22k short of ground at the minimum stop.

Background: [[file:component-notes.org::*VR2][component-notes.org VR2]] (all readings, markings,
construction, decisions) · [[file:log/2026-09-18-tube-pull-diagnostics.org][2026-09-18 log]] (traced the bleed to VR2 —
loudness ruled out, V3 pull, balance sweep, in-place resistances) ·
[[file:log/2026-09-19-vr2-silver-paint-and-voltage-sweep.org][2026-09-19 log]] (silver-paste attempt, why it failed, needle-contact
correction) · [[file:history.org::*Pickup night][history.org]] (present at pickup: "turned all the way down,
still loud").
*** TODO Wiper to Input Test
- Power off, volume full up, wiper to input lug resistance
- If resistance near zero then the fault is localized to the ground lug
- If the resistance is 10s of KOhm, then the fault might be the wiper itself.
*** TODO Repair the track
- Start with pot still in amp. See if I can get get enough visibility into the track.
- If not enough visibility, then reluctantly desolder the pot to get outside the amp for greater visibility
- Attempt to repair the track near ground with silver paint. Try to see the actual track of the wiper near the ground terminal and if I can paint the track itself with a needle.
- Last resort is disassemble the pot to repair the track
** TODO Output stage - V6's plat runs ~45V above V7-V9

Background: [[file:troubleshooting.org::*Output-stage plate/current test plan (gadget73, 2026-09-19)][troubleshooting.org]] (full procedure, gadget73's reply, why
a plate reading means two things at once, safety) ·
[[file:log/2026-09-19-vr2-silver-paint-and-voltage-sweep.org][2026-09-19 log]] (the sweep that found it) ·
[[file:measurements/2026-09-19-voltages.org][2026-09-19 measurements]] (rows 13, 44-46 — the plate readings
themselves; row 11 the shared cathode bus) · [[file:component-notes.org::*C600][component-notes.org C600]]
(shared cathode-bias network, and what's still muddled about it).
*** TODO Measure T7 and T8 center tab voltage with power on
*** TODO Measure half-primary resistance - Center tap to Pin 7 on 4 tubes power off
*** TODO Swap tubes for V6 and V7, remeasure both plate voltages
*** TODO Look for red glow powered up in dim room
