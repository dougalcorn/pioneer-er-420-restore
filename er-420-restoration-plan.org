...
** DONE Record the grid in [[file:schematic/ZONES.org][ZONES.org]]
...
** DONE Walk the whole sheet, fill in [[file:schematic/ZONES.org][ZONES.org]]'s subsystem table
...
** DONE Point [[file:schematic/ZONES.org][ZONES.org]] at the tiles covering what's in scope
